...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'form-group', error_class: 'form-group-invalid has-error', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    ...
    b.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback text-danger' }
