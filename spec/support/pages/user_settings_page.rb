...
class UserSettingsPage < SitePrism::Page
  ...
  section :new_billing_address_form,  AddressFormSection,       'form#billing_address_form'
  section :new_shipping_address_form, AddressFormSection,       'form#shipping_address_form'
